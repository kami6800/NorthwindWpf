...
namespace Entities.Migrations
{
    ...
    [Migration("20201103103227_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.CustomerCustomerDemo", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.CustomerDemographics", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasColumnName("CustomerTypeID")
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("Entities.Models.EmployeeTerritories", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Shippers", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Territories", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasColumnName("TerritoryID")
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("Entities.Models.CustomerCustomerDemo", b =>
                {
                    b.HasOne("Entities.Models.Customers", "Customer")
                        .WithMany("CustomerCustomerDemo")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers")
                        .IsRequired();

                    b.HasOne("Entities.Models.CustomerDemographics", "CustomerType")
                        .WithMany("CustomerCustomerDemo")
            ...
            modelBuilder.Entity("Entities.Models.EmployeeTerritories", b =>
                {
                    b.HasOne("Entities.Models.Employees", "Employee")
                        .WithMany("EmployeeTerritories")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_EmployeeTerritories_Employees")
                        .IsRequired();

                    b.HasOne("Entities.Models.Territories", "Territory")
                        .WithMany("EmployeeTerritories")
            ...
            modelBuilder.Entity("Entities.Models.Employees", b =>
                {
                    b.HasOne("Entities.Models.Employees", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Entities.Models.Orders", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Shippers", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Entities.Models.Products", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Suppliers", "Supplier")
                        .WithMany("Products")
